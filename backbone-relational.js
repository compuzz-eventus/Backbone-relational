...
(function (factory ) {
    ...
    _.extend(module.Relation.prototype, Backbone.Events, module.Semaphore, {
        ...
        _isReverseRelation: function (relation) {
            return this.instanceOf(relation.instance) &&
                this.reverseRelation.key === relation.key &&
                this.key === relation.reverseRelation.key;
        },

        /**
         * Checks if the provided model is an instance of the related model or any of its sub-models.
         *
         * @param {Backbone.RelationalModel} model - The model to check.
         * @returns {boolean} - Returns true if the model is an instance of the related model or any of its sub-models, false otherwise.
         */
        instanceOf: function (model) {
            return model instanceof this.relatedModel || _.any(this.relatedModel._subModels || [], function (o) {
                return model instanceof o
            });
        },
